...
const handleFileChange = (e) => {
  ...
  try {
    const response = await axios.post("https://ayush-portal-new-backend.vercel.app/api/upload-pdf",
      formData,
      {
        headers: {
  ...
  try{
    ...
    const response= await axios.post("https://ayush-portal-new-backend.vercel.app/api/licensingAuthority-reg",Licensedata);
    if(response.data.success)
    {
