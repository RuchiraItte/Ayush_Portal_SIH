...
//   const [startUpEmails , setstartUpEmails] = useState([]);
  ...
  useEffect(()=>{  // token verification
    const fetch_it = async(e)=>{
      try {
        const response = await axios.post('https://ayush-portal-new-backend.vercel.app/api/tokenverify', 
...
useEffect(() => {
    const fetchEmails = async () => {
      try {
        const response = await axios.get('https://ayush-portal-new-backend.vercel.app/api/isDrugInspectorAssigned-true');
