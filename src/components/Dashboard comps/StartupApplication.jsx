  ...
  useEffect(() => { // load user data
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.post('https://ayush-portal-new-backend.vercel.app/api/startup-dash-retrieval', { Email_ID });
            ...
            if (userExists) {
                    // Update method: Send only changed fields using PUT
                      ...
                      if (Object.keys(updatedFields).length > 0) {
                        const response = await axios.put(`https://ayush-portal-new-backend.vercel.app/api/update-fill-application/${email}`, updatedFields);
                        if (response.data.success) {
                      ...
                      const response = await axios.post('https://ayush-portal-new-backend.vercel.app/api/startup-dash-post-fillapplication', startupdata);
                      if (response.data.success) {
        ...
        <div className="container-application mt-28 relative ">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <div className=' flex w-full'>
                         <div className="form-group w-[50%] mr-2">
                           ...
                           <input  type="text"  placeholder="PAN No. of the company/Firm"   name="PANno" readOnly={!editing} value={startupdata.PANno ||""} onChange={handleChange} 
                           />
                ...
                <label>GST No. of the company/Firm</label>
                    <input type="text" placeholder="GST No. of the company/Firm" name="GSTno"readOnly={!editing}value={startupdata.GSTno ||""}onChange={handleChange} 
                    />
                ...
                <div className="form-group">
                    <label style={{fontSize:'1.5rem'}}>2. Company Certification Details</label>
